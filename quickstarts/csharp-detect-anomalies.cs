...
namespace Console
{
    class Program
    {
        ...
        static readonly string subscriptionKey = Environment.GetEnvironmentVariable("ANOMALY_DETECTOR_ENDPOINT");
        static readonly string endpoint = Environment.GetEnvironmentVariable("ANOMALY_DETECTOR_KEY");;
